            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">edit funcionario</h5>
                  </div>


<form class="row g-3  needs-validation"  action="{{route('funcionario.update', $funcionario->id)}}"  method="POST" >
    @csrf
    @method('put')
      <div class="col-12">
...
<div class="col-12">
  <label for="yourPassword" class="form-label" >salario</label>
  <input type="decimal" name="salario" class="form-control"placeholder="email"  value="{{$salario}}" required>
 <!-- <div class="invalid-feedback">Please enter your password!</div>-->
</div>
<br>
